...
const ROMANIA_CONFIG = {
  'id': 'romania',
  'src': [
    src('timisoara', 'https://data.opentransport.ro/routing/gtfs/gtfs-timisoara.zip', false),
    src('sibiu', 'https://data.opentransport.ro/routing/gtfs/gtfs-sibiu.zip', false),
    src('bucharest', 'https://data.opentransport.ro/routing/gtfs/gtfs-bucharest.zip', false),
